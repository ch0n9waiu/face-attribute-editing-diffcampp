...
class TrainDAOpts:
    ...
    def initialize(self):
        self.parser.add_argument('--trainset_path', type=str, default='./datasets/ffhq')
        self.parser.add_argument('--testset_path', type=str, default='./datasets/celeba1000')
        ...
        self.parser.add_argument('--direction_path', type=str, default='./directions')
        self.parser.add_argument('--alpha', type=int, default=20, help="coefficient to be multiplied to directions")
        self.parser.add_argument('--exp_dir', type=str, default='./trainDA/gradcam++eig')
